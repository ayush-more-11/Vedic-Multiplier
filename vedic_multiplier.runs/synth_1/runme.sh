...
HD_PWD='D:/Ayush/projects/DSD/Lab_7/vedic_multiplier/vedic_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vedic_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vedic_Multiplier.tcl
